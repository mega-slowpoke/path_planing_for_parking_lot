...
class Environment:
    def __init__(self,obstacles):
        self.margin = 5     # margin of environment
        #coordinates are in [x,y] format
        self.car_length = 80    
        self.car_width = 40
        self.wheel_length = 15
        self.wheel_width = 7
        self.wheel_positions = np.array([[25,15],[25,-15],[-25,15],[-25,-15]])  # position of wheels at the starting point
        
        self.color = np.array([0,0,255])/255        # car color is red
        self.wheel_color = np.array([20,20,20])/255 # wheel color is black
        ...
        self.background[10:1000+20*self.margin:10,:] = np.array([200,200,200])/255  # set backgournd to white
    ...
    def place_obstacles(self, obs):
        ...
        # set all obstacle cells to black
        for ob in obstacles:
            self.background[ob[1]:ob[1]+10,ob[0]:ob[0]+10]=0
    
    """
    Draws a path on the background image.
    """
    ...
    """
    Render the car on the background image.

    Returns: np.ndarray: The rendered image of the car.
    """
...
class Parking1:
    def __init__(self, car_pos):
        ...
        # self.walls contains a list of coordinates representing the wall cells
